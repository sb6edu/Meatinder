 ...
 * @author 103098
 */
@WebServlet(name = "Ctrldeleteupdateadmin", urlPatterns = {"/ctrldeleteupdateadmin.do"})
public class Ctrldeleteupdateadmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher view = request.getRequestDispatcher("rezept_bearbeiten_admin.jsp");
